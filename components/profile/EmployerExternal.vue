        ...
        <div class="profile profile-mobile-main relative mt-10">
            ...
            <template v-if="isScreenSmall">
                <div class="profile-mobile-wrapper">
                    ...
                    <p v-if="props.user.role.current === 'individual'" class="profile-mobile profile__name">
                                {{ props.user.userData.name }} {{ props.user.userData.surname }}
                            </p>
                            <p v-if="props.user.role.current === 'legal_entity'" class="profile-mobile profile__name">
                                {{ props.user.userData.title }}
                            </p>
                ...
                <div class="mb-6 mt-n5 profile-about-mobile">
                    <p class="profile-mobile-info profile__info mt-4">{{ age }}</p>
                        ...
                        <p v-if="props.user.role.current === 'legal_entity'" class="profile-mobile-info profile__info flex items-center underline gap-1 mt-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <mask id="mask0_772_1020" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                  <rect width="24" height="24" fill="#D9D9D9"/>
                                </mask>
                                <g mask="url(#mask0_772_1020)">
                                  <path d="M9.55 18L3.85 12.3L5.275 10.875L9.55 15.15L18.725 5.97498L20.15 7.39998L9.55 18Z" fill="#604D9E"/>
                                </g>
                              </svg>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full flex justify-between">
                            <p v-if="props.user.role.current === 'individual'" class="profile__name">
                                {{ props.user.userData.name }} {{ props.user.userData.surname }}
                            </p>
                            <p v-if="props.user.role.current === 'legal_entity'" class="profile__name profile__name--small">
                                {{ props.user.userData.title }}
                            </p>
                        </div>
            ...
            <div class="profile__right profile-about-mobile">
                ...
                <p v-if="props.user.role.current === 'legal_entity'" class="profile__info flex items-center underline gap-1 mt-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <mask id="mask0_772_1020" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                          <rect width="24" height="24" fill="#D9D9D9"/>
                        </mask>
