...
const isInMyVacancies = computed(() => {
    return vacanciesStore.vacanciesUser.some(vacancy => vacancy.uuid === route?.params?.id);
})
onMounted(async() => {
            ...
            <template v-if="isScreenSmall">
                <div class="profile-mobile-wrapper">
                    ...
                    <div>
                     ...
                     <!-- РЕДАКТИРОВАТЬ -->
                     <NuxtLink v-if="isInMyVacancies" class="cursor-pointer" :to="{ name: 'vacancies-edit-id', params: { id: vacancy?.uuid } }">
                ...
                <div class="w-full flex flex-col" v-if="userStore.user.role.current === 'applicant'">
                    <button class="btn">
                        Откликнуться
                    </button>
                    ...
                    <div class="items-center justify-center flex mt-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="19" viewBox="0 0 20 19" fill="none">
                            <path d="M6.85 14.825L10 12.925L13.15 14.85L12.325 11.25L15.1 8.85L11.45 8.525L10 5.125L8.55 8.5L4.9 8.825L7.675 11.25L6.85 14.825ZM3.825 19L5.45 11.975L0 7.25L7.2 6.625L10 0L12.8 6.625L20 7.25L14.55 11.975L16.175 19L10 15.275L3.825 19Z" fill="#545388"/>
                        </svg>
                        <p class="color-purple text">
                            В избранное
                        </p>
                    </div>
                </div>
...
<!-- //РЕДАКТИРОВАТЬ -->
                ...
                <p class="profile__about mt-3">
                    ...
                    <div class="flex column" v-if="userStore.user.role.current === 'applicant'">
                        <button class="btn">
                            Откликнуться
                        </button>
                        <button class="btn mt-2">
