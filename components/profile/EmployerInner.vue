...
const shortDescriptionLength = ref(200);
    ...
    <div class="profile profile-about-mobile mt-10">
      <div class="profile__left">
        ...
        <div class="profile__vacancies mt-5">
          <!-- VACANCIES ITEM -->
          <a
            v-for="vacancy in vacanciesStore.vacanciesUser"
            :key="vacancy.uuid"
            class="profile__vacancies-item"
          >
            <div class="profile__vacancies-item-head">
              <NuxtLink
                :to="{ name: 'vacancies-id', params: { id: vacancy.uuid } }"
                class="profile__vacancies-item-name"
              >
                {{ vacancy.title }}
              </NuxtLink>
      ...
      <div class="profile__right">
        <template v-if="actualVacancy && actualVacancy !== undefined">
          ...
          <div class="flex items-center gap-1 mt-4">
            ...
            <p class="profile__info">{{ actualVacancy?.place }}</p>
          </div>
          <!-- НЕОБХОДИМ ОПЫТ РАБОТЫ -->
          <div
            v-if="actualVacancy?.required_experience"
          ...
          <p class="profile__about mt-3">
            {{ actualVacancy?.time }}. {{ actualVacancy?.description }}
          </p>
