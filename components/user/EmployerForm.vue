    ...
    <div class="relative">
      ...
      <template v-if="selectedRole === 'corporate'">
        <form @submit.prevent="submit(formCorporate)" class="mt-5">
          ...
          <input
            v-model="formCorporate.userData.title"
            placeholder="Название"
            type="text"
            class="field mt-3"
          />
          <input
            v-model="formCorporate.userData.inn"
            placeholder="ИНН"
            type="text"
            class="field mt-3"
          />
          <textarea
            v-model="formCorporate.userData.contact_info"
            placeholder="Контактная информация"
            class="field mt-3"
          ></textarea>
          <input
            v-model="formCorporate.email"
            placeholder="Рабочий Email"
            type="email"
            class="field mt-3"
          />
          <input
            v-model="formCorporate.password"
            placeholder="Пароль"
            type="password"
            class="field mt-3"
          />
          ...
          <textarea
            v-model="formCorporate.userData.summary"
      ...
      <template v-else>
        <form @submit.prevent="submit(formIndividual)" class="mt-5">
          <FormUploadImage @change="uploadImage" />
          <input
            v-model="formIndividual.userData.surname"
            placeholder="Фамилия"
            type="text"
            class="field mt-3"
          />
          <input
            v-model="formIndividual.userData.name"
            placeholder="Имя"
            type="text"
            class="field mt-3"
          />
          <input
            v-model="formIndividual.userData.patronymic"
            placeholder="Отчество"
            type="text"
            class="field mt-3"
          />
          <input
            v-model="formIndividual.email"
            placeholder="Email"
            type="text"
            class="field mt-3"
          />
          <input
            v-model="formIndividual.password"
            placeholder="Пароль"
            type="password"
            class="field mt-3"
          />
          ...
          <textarea
            v-model="formIndividual.userData.summary"
            placeholder="Какая помощь необходима?"
            class="field mt-3"
          ></textarea>
          <template v-if="formErrors">
